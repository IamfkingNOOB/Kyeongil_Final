...
public class MainValkyrie : MonoBehaviour
{
    ...
    private void SetMainValkyrie()
    {
        ...
        ValkyrieData mainValkyrie = GetAlreadySetMainValkyrie(alreadySetMainValkyrieID);
    ...
    private ValkyrieData GetAlreadySetMainValkyrie(int playerPrefs)
    {
        // 발키리 목록을 가져옵니다.
        Dictionary<int, ValkyrieData> valkyrieList = DataManager.Instance.ValkyrieList;
    ...
    private ValkyrieData GetRandomValkyrie(Dictionary<int, ValkyrieData> dictionary)
    {
        // 발키리를 무작위로 한 명 골라, 반환합니다.
        ValkyrieData randomValkyrie = dictionary.ElementAt(Random.Range(0, dictionary.Count)).Value;
